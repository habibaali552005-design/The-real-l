    ...
    specDefinitions: [
      {
        ...
        unit: "لتر",
        required: true,
        description: "مثال: 340 لتر أو 450 لتر",
      },
      {
        id: "doors_count",
        name: "عدد الأبواب",
  ...
  tpl_furniture_base: {
    ...
    specDefinitions: [
      ...
      },
      {
        ...
        type: "number",
        description: "مثال: 5 قطع أو 9 قطع",
      },
      {
        id: "dimensions_cm",
        name: "الأبعاد (العرض × الطول × الارتفاع)",
        type: "text",
        description: "مثال: 200×160×90 سم",
      },
    ],
    allowedOptionTypes: [
      {
    ...
    specDefinitions: [
      {
        ...
        name: "الوزن / الصافي",
        type: "text",
        description: "مثال: 500 جرام أو 1 كجم أو 1 لتر",
      },
      {
...
export const MARKETPLACE_CATALOG_TREE: Array<{
...
}> = [
  {
    ...
    subCategories: [
      ...
      "سخانات مياه",
      "فلاتر مياه",
      "مراوح وأجهزة تنقية الهواء",
    ],
  },
  {
    mainCategory: "الهواتف والإكسسوارات",
    templateId: "tpl_phones_base",
    subCategories: [
      "هواتف ذكية",
      "ساعات وسوارات ذكية",
      "سماعات بلوتوث ولاسلكية",
      "شواحن وكابلات",
      "جرابات وواقيات شاشة",
      "باور بانك وملحقات",
    ],
  ...
  {
    mainCategory: "الكمبيوتر والألعاب",
    templateId: "tpl_appliances_base",
    subCategories: [
      "أجهزة لابتوب",
      "كمبيوتر مكتبي (Desktop)",
      "شاشات كمبيوتر",
      "أجهزة ألعاب (PlayStation / Xbox / Switch)",
      "كروت شاشة ومعالجات",
      "ماوس ولوحات مفاتيح وسماعات جيمينج",
    ],
  },
  {
    mainCategory: "الملابس والأزياء",
  ...
  {
    mainCategory: "الأطفال والرضع والألعاب",
    templateId: "tpl_fashion_base",
    subCategories: [
      "عربات ومقاعد أطفال",
      "مستلزمات تغذية وتطعيم",
      "ألعاب تعليمية وترفيهية",
      "ملابس وأحذية بيبي",
    ],
  },
  {
    mainCategory: "المعدات الصناعية والزراعية والطبية",
    templateId: "tpl_appliances_base",
    subCategories: ["معدات ورش ومصانع", "أدوات زراعية ومحاصيل", "مستلزمات وأجهزة طبية"],
  },
  {
    mainCategory: "الخدمات والمنتجات الرقمية",
    templateId: "tpl_appliances_base",
    subCategories: ["خدمات تصميم وبرمجة", "صيانة منزلية وتشطيبات", "دورات واشتراكات رقمية"],
  },
];
